...
Commands:
  ...
  github                       connect a cloud hub to GitHub
...
<CardGroup cols={1}>
  <Card title="pinbox github" icon="github" href="/cli/commands/github">
    Create and install the GitHub App a cloud hub links issues through. Interactive; a
    person runs it.
  </Card>
</CardGroup>
