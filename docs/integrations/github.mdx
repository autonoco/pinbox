...
```bash
pinbox github setup --hub https://<worker-host>/_pinbox
```
...
the repo. Deploy the worker and you are done. Add `--personal` if the repo belongs to a
user account rather than an organization, `--print-secrets` to set the secrets yourself.
